...
class ActiveRecord{
  ...
  public function sanitizarAtributos(){
    ...
    foreach ($atributos as $key => $value) {
      $sanitizado[$key] = self::$db->quote($value); # quote() evita SQL Inyection
    }
    return $sanitizado;
  }
  ...
  //? Todos los registros
  public static function all($columnaId){
    $query = "SELECT * FROM " . static::$tabla . " ORDER BY {$columnaId}";
    // debuguear($query);
